...
[Download KAIRO for Windows x64](https://github.com/syric28-debug/Kairo/releases/download/v1.0.2/KAIRO_1.0.2_x64-setup.exe)

For modern 64-bit Windows systems.

### Windows 32-bit

[Download KAIRO for Windows x86](https://github.com/syric28-debug/Kairo/releases/download/v1.0.2/KAIRO_1.0.2_x86-setup.exe)
...
1. Download the installer matching your architecture:
   - For 64-bit Windows: `KAIRO_1.0.2_x64-setup.exe`
   - For 32-bit Windows: `KAIRO_1.0.2_x86-setup.exe`
